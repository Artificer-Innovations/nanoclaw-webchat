...
export const ADAPTER_COPY_RULES: AdapterCopyRule[] = [
  ...
  { source: 'webchat-boot.test.ts', dest: 'src/webchat-boot.test.ts' },
  { source: 'webchat-hosthooks.ts', dest: 'src/webchat-hosthooks.ts' },
  { source: 'webchat-hosthooks.test.ts', dest: 'src/webchat-hosthooks.test.ts' },
